...
gatk VariantFiltration \
    ...
    #           Removing Genotype filters failed
    cat ${results}/analysis-ready-snps.vcf | grep -v -E "DP_filter|GQ_filter" > analysis-ready-snps-filteredGT.vcf
    cat ${results}/analysis-ready-indels.vcf | grep -v -E "DP_filter|GQ_filter" > analysis-ready-indels-filteredGT.vcf
...
gatk Funcotator  \
    ...
    --reference ${ref}  \
    --ref-version  hg38 \
    --data-sources-path /home/nikos/WGS_project/scripts/funcotator_dataSources.v1.7.20200521g \
...
gatk VariantsToTable \
        -V ${results}/analysis-ready-snps-filteredGT-funcotated.vcf  -F  AC  -F  AN -F  DP -F  FUNCOTATION \
